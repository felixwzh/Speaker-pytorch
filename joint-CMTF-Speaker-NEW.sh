...
speaker_rounds_num=4
# 3. rounds that we train S3CMTF model
S3CMTF_rounds_num=4
exp_prefix="joint-NEW-0428"
log_file="/home/felix/project/Speaker-pytorch/log/${exp_prefix}_general.log"


# S3CMTF param
S3CMTF_base_dir="/home/felix/project/PerGen/src_data_NEW_PCA_dim_384"
S3CMTF_prefix=${exp_prefix}
S3CMTF_last_rounds_dir='results_lr_5e-4_1_4_15x30x20'
S3CMTF_lr=0.0005
S3CMTF_lambda_reg=1
S3CMTF_lambda_c=4
...
speaker_data_folder="data/src_data_NEW_0427"
speaker_save_prefix="speaker.model"
speaker_batch_size=200
speaker_layers=2
speaker_epochs=${speaker_rounds_num}
speaker_eval_steps=1000
speaker_PersonaNum=5226
speaker_save_steps=1
speaker_train_size=874555
